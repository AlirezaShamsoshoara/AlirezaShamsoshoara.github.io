...
My research area focuses on Unmanned Aerial Vehicle (UAV), Internet of Things (IoT) networks, and performing Dynamic Spectrum Assignment (DSA) for these kinds of networks. In my research, I target machine learning algorithms such as Reinforcement Learning (RL) to address different problems such as localizations, task allocation, scheduling, and so on. 
